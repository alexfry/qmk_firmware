...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT( /* Base */
      KC_NLCK, KC_KP_SLASH, KC_KP_ASTERISK, KC_KP_MINUS, MI_C_4,\
      KC_KP_7, KC_KP_8, KC_KP_9, KC_KP_PLUS, MI_C_3,\
      KC_KP_4, KC_KP_5, KC_KP_6,_______, MI_C_2,\
      KC_KP_1, KC_KP_2, KC_KP_3, KC_KP_ENTER,MI_C_1,\
